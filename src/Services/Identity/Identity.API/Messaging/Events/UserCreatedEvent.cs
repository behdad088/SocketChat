...
{
    public static string CloudEventType => EventConstants.UserCreatedCloudEventType;
    public static string ExchangeName => EventConstants.UserCreatedExchangeName;

    public static UserCreatedEvent FromUser(ApplicationUser user, DateTimeOffset occurredAt) => new(
        user.Id,
        user.Email!,
        user.UserName!,
        user.Name,
